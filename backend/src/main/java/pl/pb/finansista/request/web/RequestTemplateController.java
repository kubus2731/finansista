...
public class RequestTemplateController {
  ...
  public ResponseEntity<List<RequestTemplateResponse>> getAllTemplates() {
    return ResponseEntity.ok(
        getAllRequestTemplatesUseCase.execute().stream().map(RequestTemplateResponse::of).toList());
  }
  ...
  public ResponseEntity<RequestTemplateResponse> createTemplate(
    ...
    RequestTemplate template =
        createRequestTemplateUseCase.execute(request.title(), request.description());
  ...
  public ResponseEntity<RequestTemplateResponse> editTemplate(
    ...
    RequestTemplate template =
        editRequestTemplateUseCase.execute(
            id, request.title(), request.description(), request.active(), version);
    return ResponseEntity.ok()
        .eTag(ETags.format(template.getVersion()))
        .body(RequestTemplateResponse.of(template));
  }
