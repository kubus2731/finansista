...
public record RequestResponse(
  ...
  public static RequestResponse of(
      Request request, RequestPermissions permissions, Predicate<RequestFunding> canGrant) {
    ProjectDetails pd =
        request.getProjectDetails() != null ? request.getProjectDetails() : ProjectDetails.empty();
    SupervisorInfo sup =
        request.getSupervisor() != null ? request.getSupervisor() : SupervisorInfo.empty();
    ...
    return new RequestResponse(
        ...
        request.getTemplate() != null
            ? ExternalIdEncoder.encode("tpl", request.getTemplate().getExternalId())
            : null,
  ...
  public record RequestPermissions(
      boolean canEdit,
      boolean canDelete,
